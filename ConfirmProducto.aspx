<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfirmProducto.aspx.cs" Inherits="Cookie_2613827.ConfirmProducto" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <p>
     <asp:Label ID="lblRecorderLabel" runat="server" Text="Number on Order:"></asp:Label>
